...
function HeroSection() {
  return (
    <section className="flex flex-col gap-12 tablet:gap-18 desktop:pl-41 desktop:flex-row-reverse desktop:gap-0 desktop:items-center">
      <div className="relative px-2.5 pt-8 pb-2 flex tablet:px-14 tablet:pb-6 desktop:shrink-0 desktop:w-183.75 desktop:p-0 desktop:pl-4 desktop:pb-6.5">
        <img src={illustration} alt="Screen illustration" className="z-10 grow desktop:grow-0 desktop:w-164" />
        <div className="absolute bottom-0 right-0 bg-blue-600 w-[80%] h-[70%] rounded-l-full tablet:h-[65%] tablet:w-[70%]" />
      </div>

      <div className="px-7 text-center flex flex-col gap-6 tablet:px-28.5 desktop:text-start desktop:px-0">
