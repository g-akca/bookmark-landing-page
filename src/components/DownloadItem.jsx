...
function DownloadItem({ img, name, ver }) {
  return (
    <div className="py-8 flex flex-col gap-6 bg-white shadow-[0_10px_20px_rgba(73,93,207,0.05)] rounded-[15px] tablet:py-6 tablet:gap-4">
      <div className="flex flex-col gap-8 items-center tablet:gap-4">
        <img src={img} alt={`${name} logo`} className="h-25 tablet:h-20" />
      ...
      <Button className="px-8 bg-blue-600 text-white self-center tablet:text-[14px] tablet:leading-[200%] tablet:px-3 tablet:py-1">
